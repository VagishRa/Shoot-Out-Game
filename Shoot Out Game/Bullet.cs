...
namespace Shoot_Out_Game
{
    class Bullet
    {
        ...
        //Top and left location of bullet
        ...
        public void MakeBullet(Form form)               
            // function for bullet, bullet gets added to form
        {
            // using drawing namespace, color of bullet
            ...
            // CALLING FORM and adding bullet to the form.

            bulletTimer.Interval = speed;
            bulletTimer.Tick += new EventHandler(BulletTimerEvent);         
            //each bullet comes wioth its own timer, its going to know which way to move inside the timer function
            bulletTimer.Start();
        }
        ...
        private void BulletTimerEvent(object sender, EventArgs e)
        {
            ...
            // move bullet to direction it came in from, up up side side etc.
