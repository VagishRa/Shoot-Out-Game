    ...
    public partial class Form1 : Form
    {
        ...
        private void MainTImerEvent(object sender, EventArgs e)
        {
            ...
            foreach (Control x in this.Controls)                 // loop for if we can collect ammo
            {
                ...
                {
                    if (player.Bounds.IntersectsWith(x.Bounds)) playerHealth -= 1;                     // IF player is hit by zombie, then health minus 1
        ...
        private void RestartGame()
        {
            ...
            foreach(PictureBox i in zombieList) this.Controls.Remove(i);                    // remove zombies from list
